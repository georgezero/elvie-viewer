...
// empty-path.js
var empty_path_exports = {};
__export(empty_path_exports, {
  default: () => empty_path_default
});
var empty_path_default;
var init_empty_path = __esm({
  "empty-path.js"() {
    empty_path_default = {};
  }
});
    ...
    var libjpegturbowasm_decode = (() => {
      ...
      return function(libjpegturbowasm_decode2) {
        ...
        if (ENVIRONMENT_IS_NODE) {
          ...
          var nodePath = (init_empty_path(), __toCommonJS(empty_path_exports));
